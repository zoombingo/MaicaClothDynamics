...
namespace ClothDynamics
{
    ...
    public class BezierSpline : MonoBehaviour
    {
        ...
        //[SerializeField]
        [HideInInspector]
        public SplineAutoConstructMode Internal_AutoConstructMode = SplineAutoConstructMode.Linear;
#endif
        ...
        public void Refresh()
        {
            ...
            //{
            //    if (endPoints[i].transform.parent != this.transform)
        ...
        public void Reset()
        {
            ...
            endPoints[0].localPosition = Vector3.down + offset;
            endPoints[1].localPosition = Vector3.up + offset;
            endPoints[2].localPosition = Vector3.up + Vector3.right + offset;
            endPoints[3].localPosition = Vector3.down + Vector3.right + offset;
            ...
            UnityEditor.Undo.RegisterCreatedObjectUndo(endPoints[2].gameObject, "Initialize Spline");
            UnityEditor.Undo.RegisterCreatedObjectUndo(endPoints[3].gameObject, "Initialize Spline");
