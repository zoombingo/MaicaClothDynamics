...
namespace ClothDynamics.Unity.Extensions
{
    public partial class DelaunatorPreview : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Return))
            {
                ...
                var sampler = UniformPoissonDiskSampler.SampleRectangle(-Vector2.one*4, Vector2.one*4, generationMinDistance);
        ...
        private void CreateLine(Transform container, string name, Vector3[] points, Color color, float width, int order = 1)
        {
            ...
            lineRenderer.material = lineMaterial ==null ? new Material(Shader.Find("Standard")) : lineMaterial;
        ...
        private void CreateMesh()
        {
            ...
            meshRenderer.sharedMaterial = meshMaterial == null ? new Material(Shader.Find("Standard")) : meshMaterial;
