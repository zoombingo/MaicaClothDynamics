...
namespace ClothDynamics
{
    ...
    /// <summary>
    /// This is currently doing nothing, it will be edit or removed in the future. (TODO)
    ...
    public class AssetPostProcessorReorderBones : AssetPostprocessor
    {
        ...
        void Process(GameObject g)
        {
            ...
            boneTransforms = boneTransforms.OrderBy(x => x.GetSiblingIndex()).ToList(); //TODO test
