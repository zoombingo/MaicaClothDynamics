...
namespace ClothDynamics
{
    ...
    public static class EditorHelper
    {
        ...
        {
            return DrawHeader(text, text, false, width);
        }

        static public bool DrawHeader(string text, string key, float width = float.NaN)
        {
            return DrawHeader(text, key, false, width);
        }

        static public bool DrawHeader(string text, bool forceOn, float width = float.NaN)
        {
            return DrawHeader(text, text, forceOn, width);
        }

        static public bool DrawHeader(string text, string key, bool forceOn, float width = float.NaN)
        {
