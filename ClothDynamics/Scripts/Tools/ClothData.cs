...
namespace ClothDynamics
{
    ...
    public enum DampingMethod { noDamping, simpleDamping, smartDamping, smartAndSimpleDamping }
    public enum BendingMethod { DihedralBending, isometricBending }
    public enum PointConstraintType { none, blueVertexColor/*, topRow, topCorners, leftRow, leftCorners*/ }
